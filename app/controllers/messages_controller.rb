class MessagesController < ApplicationController
  ...
  before_action :verify_if_user_can_manage?, except: [:create]
  ...
  private
    ...
    def message_params
      params.require(:message).permit(:name, :lastname, :email, :phone, :message)
    end

    def verify_if_user_can_manage?
      redirect_to dashboard_path unless current_user.admin.can_manage_messages
    end
end
