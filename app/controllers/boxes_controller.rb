class BoxesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @box.update(box_params)
        format.html { redirect_to boxes_url, notice: 'Sección actualizada correctamente' }
  ...
  private
    ...
    def box_params
      params.require(:box).permit(:title, :description, :url)
    end

    def verify_if_user_can_manage?
      redirect_to dashboard_path unless current_user.admin.can_manage_boxes
    end
end
