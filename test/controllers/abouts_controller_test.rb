...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { mission: @about.mission, statute_pdf: @about.statute_pdf, vision: @about.vision } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { mission: @about.mission, statute_pdf: @about.statute_pdf, vision: @about.vision } }
