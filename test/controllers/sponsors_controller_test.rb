...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post sponsors_url, params: { sponsor: { event_id: @sponsor.event_id, image: @sponsor.image } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { event_id: @sponsor.event_id, image: @sponsor.image } }
