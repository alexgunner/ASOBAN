...
class BoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post boxes_url, params: { box: { description: @box.description, title: @box.title, url: @box.url } }
    end
  ...
  test "should update box" do
    patch box_url(@box), params: { box: { description: @box.description, title: @box.title, url: @box.url } }
